...
//to all messages sent by the user
    ...
    populateMessages: function(results, animate) {
      ...
      console.log('results from populateMessages' + results);
      app.clearMessages();
      // app.stopSpinner();
    ...
    addMessage: function(data) {
      ...
      if (data.room === app.roomname) {
        ...
        $username.text(data.author+': ').attr('data-username', data.author).attr('data-roomname',data.room).appendTo($chat);

        // Add the friend class
        if (app.friends[data.author] === true)
